...
?> 
  <tr>
	...
	if($data["date_verify1"]!=""){
		echo "Verify By $data[aid_verify1] at $data[date_verify1]"; 
	}// if($data["datesubmit"]!="")
	...
	if($data["date_verify2"]!=""){
		echo "Verify By $data[aid_verify2] at $data[date_verify2]"; 
	}// if($data["datesubmit"]!="")
...
<a href="javascript:window.open('<?php echo $site; ?>/bendahari_control/approve_user_action/<?php echo $data["inv_code"]."/1/".$data["codeuser"]; ?>','width=200,height=100')" target="_blank" onclick="return confirm('Approve this payment?')" title="Payment"><button style="font-size:7pt;color:white;background-color:green;border:2px solid #336600;padding:3px">Approve Payment</button></a>

<a href="javascript:window.open('<?php echo $site; ?>/bendahari_control/approve_user_action/<?php echo $data["inv_code"]."/0/".$data["codeuser"]; ?>','width=200,height=100')" target="_blank" onclick="return confirm('Reject the payment?')" title="Payment"><button style="font-size:7pt;color:white;background-color:red;border:2px solid #336600;padding:3px">Reject Payment</button></a>
<?php
