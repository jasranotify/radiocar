...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="<?php echo $site; ?>/bendahari_control/profile?ref=profile" <?php echo $activeprofile; ?>>Profile</a></li>
            <li><a href="<?php echo $site ?>/bendahari_control/list_users_new?ref=list_users" <?php echo $activelist_users; ?> >New User</a></li>
            <li><a href="<?php echo $site ?>/bendahari_control/list_users_verified?ref=list_users_verified" <?php echo $activelist_verified; ?> >Verified User</a></li>
            <li><a href="<?php echo $site ?>/bendahari_control/list_users_approved?ref=list_users_approved" <?php echo $activelist_approved; ?> >Approved User</a></li>
...
?>	
			 ...
			 <li><a href="<?php echo $site; ?>/bendahari_control/invoice?ref=invoice" <?php echo $activeinvoice; ?>>Invoice</a></li>
