...
//$aname=$_SESSION["logs"]["nama"];
$q="select a.nama,a.ic,a.phone,a.email,a.username,a.password from tbl_user a where a.codeuser='$codeuser'";
...
if($statuss==0){
	...
	if(isset($_POST["submit"])){
		...
		$q1=" insert into tbl_email_keluar set kategori='APPROVE_USER',subjek='User Approval Failed ',uid='$id',aid='$aid',recipient_name='$nama',receipent='$email',sender='admin@mydomain.com',cc='',content='$_POST[rejectednoted] <br> Rejected on: $datenow by $aname',date_submit='$datenow',status='0'";
...
if($statuss==1){
	...
	$q1=" insert into tbl_email_keluar set kategori='AAPROVE_USER',subjek='User Approval Success',uid='$codeuser',aid='$aid',recipient_name='$nama',receipent='$email',sender='admin@mydomain.com',cc='',content='Your Account is Approved.Please log in at $base using $username as Username and $password as the password to Access to your account.Tq For Join us <br> Approved on: $datenow by $aname',date_submit='$datenow',status='0'";
