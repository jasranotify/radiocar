...
if($inv_status==2){echo "Paid By user and Approved by admin";}//if($inv_status==1)
if($inv_status==3){echo "Payment Rejected by admin";}//if($inv_status==1)
?>
  ...
  <div id="content">
    <p>
      ...
      Name: <?php echo $dataaaaa["nama"];?><br />
       Address: <?php echo $dataaaaa["address"];?><br />
	  Contact: <?php echo $dataaaaa["phone"]." / ".$dataaaaa["email"];?>    </p>
    <hr>
    <table>
      <tr>
    ...
    <hr>
    <p>
      Thank you for your order!  This transaction will appear on your billing statement as XXX.<br />
      If you have any questions, please feel free to contact us at <a href="mailto:youremail@somewhere.com">info@xxx.com</a>.    </p>
...
<div align="center">
<a onclick="window.open ('<?php echo $site."/user_control/print_inv?refid=$init_code&id=$_GET[userid]"; ?>', 'mywindow','location=3,status=1,scrollbars=1, width=600,height=600');" href="#" title="Print"><img src="<?php echo $base; ?>include/images/printer.png" width="100" height="100"/></a>
